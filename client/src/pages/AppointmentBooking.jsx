...
const AppointmentBooking = () => {
  ...
  const validate = () => {
    ...
    if (!isValidEthiopianPhone(form.phone))
      errs.phone = "Enter a valid Ethiopian phone number";
    ...
    if (!form.date) {
      ...
      if (picked.getTime() <= Date.now()) {
        ...
        errs.date =
          "The clinic does not accept new bookings on Sunday. Please pick another day.";
      } else {
        const hour = picked.getHours();
        // 8:00 AM to 7:00 PM (Ethiopian 2:00 morning to 1:00 night)
        if (hour < 8 || hour >= 19) {
          errs.date =
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-5 pt-24 pb-16">
        <div className="card p-10 max-w-md text-center">
          ...
          <p className="font-semibold text-ink mb-6">
          ...
          <p className="text-dim text-sm">
            Our front desk will confirm via phone or email shortly. We'll also
            remind you before your visit.
          </p>
          <button
            onClick={() => {
              setSuccess(false);
              setForm((f) => ({ ...f, date: "", reasonNote: "" }));
            }}
      ...
      <div className="max-w-xl mx-auto">
        <Reveal className="text-center mb-10">
          ...
          <p className="text-dim text-sm mt-3">
            The clinic is open Mon-Sat, 8:00 AM to 7:00 PM (2:00 morning to 1:00
            night).
          </p>
        </Reveal>
        ...
        <Reveal delay={100} className="card p-8">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div>
              <label className="label" htmlFor="reasonNote">
