import { Bone, HeartPulse, Activity, Brain, Sparkles, Footprints } from 'lucide-react';
    ...
    <div className="pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        <Reveal className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h1 className="font-display font-bold text-4xl sm:text-5xl mb-4">ዋና ዋና አገልግሎቶቻችን</h1>
