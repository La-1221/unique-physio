...
import {
  ArrowRight, Phone, CheckCircle2, Activity, Brain, Bone,
  HeartPulse, Footprints, Sparkles, Baby, Zap,
  MapPin, Mail, Clock, Instagram, Facebook, Send, Music2, MessageCircle
} from "lucide-react";
import RecoveryTrace from "../components/RecoveryTrace";
import Reveal from "../components/Reveal";
import {
  CLINIC_PHONE_TEL, CLINIC_PHONE_DISPLAY, CLINIC_PHONE_INTL,
  CLINIC_EMAIL, CLINIC_ADDRESS_EN, CLINIC_ADDRESS_AM,
  CLINIC_HOURS_EN, CLINIC_HOURS_AM, CLINIC_SOCIAL,
...
const treatments = [
  ...
  { icon: Bone, en: "Hip, Pelvic, Knee & Ankle Pain", am: "የጭን፣ ጉልበትና ቁርጭምጭሚት ህመም" },
  ...
  { icon: Footprints, en: "Gait & Biomechanical Problems", am: "የእግር አካሄድ ችግር" },
  { icon: Brain, en: "Facial & Bell's Palsy", am: "የፊት ሽባነት" },
  { icon: HeartPulse, en: "Cupping & Dry Needling Therapy", am: "ኩባያ ህክምና" },
];

const specialities = [
  { icon: Bone, en: "Orthopedic Rehab", am: "የአጥንት ህክምና", desc: "Recovery from bone, joint, and muscle injuries to restore full body mobility, for post-surgery, fractures, and sprains." },
  { icon: Activity, en: "Spine & Back Care", am: "የአከርካሪ እና ጀርባ ህክምና", desc: "Specialized targeted therapies to relieve chronic lower back pain, sciatica, and neck pain to improve posture and comfort." },
  { icon: Footprints, en: "Sports Therapy", am: "የስፖርት ጉዳት ህክምና", desc: "Advanced conditioning and targeted injury rehabilitation designed tailored specifically for professional or casual athletes." },
  { icon: Brain, en: "Neurological Rehab", am: "የነርቭ ስርዓት ህክምና", desc: "Focused neuromuscular retraining to improve balance, coordination, and independent movement after stroke or nerve conditions." },
  { icon: HeartPulse, en: "Cupping & Dry Needling", am: "ኩባያ እና መርፌ ህክምና", desc: "Traditional and modern modalities used to relieve muscle tension, improve circulation, and accelerate pain relief." },
  { icon: Sparkles, en: "Pediatric Physiotherapy", am: "የህጻናት ፊዚዮቴራፒ", desc: "Gentle, developmentally-appropriate therapy for children with movement, posture, or coordination challenges." },
];
  ...
  return (
    <>
      ...
      <section id="home" className="relative pt-36 pb-24 lg:pt-44 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-5 lg:px-8 relative">
          <div className="max-w-3xl">
            ...
            <h1 className="font-display font-extrabold text-4xl sm:text-5xl lg:text-6xl leading-[1.05] text-balance animate-floatUp" style={{ animationDelay: "80ms" }}>
              Move Without Pain.<br />
              <span className="text-teal">Live Without Limits.</span>
            </h1>
            <p className="amharic text-xl sm:text-2xl font-semibold text-teal-light mt-4 animate-floatUp" style={{ animationDelay: "140ms" }}>
              ያለ ህመም ይንቀሳቀሱ። ያለ ገደብ ይኑሩ።
            </p>
            <p className="text-dim text-base sm:text-lg mt-6 max-w-xl animate-floatUp" style={{ animationDelay: "200ms" }}>
              We provide advanced, personalized physical therapy to help you recover faster, regain your strength, and get back to doing what you love.
            </p>
            <div className="flex flex-wrap gap-4 mt-9 animate-floatUp" style={{ animationDelay: "260ms" }}>
      ...
      <section className="py-20 lg:py-28 bg-surface/40">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <Reveal className="text-center max-w-2xl mx-auto mb-14">
            <p className="text-teal text-sm font-semibold tracking-widest uppercase mb-3">What We Treat</p>
            <h2 className="font-display font-bold text-3xl sm:text-4xl">Conditions we treat / የምናክማቸው ችግሮች</h2>
          </Reveal>
            ...
            {treatments.map((t, i) => (
              <Reveal key={t.en} delay={i * 40}>
                <div className="card p-5 h-full hover:border-teal/40 hover:-translate-y-1 transition-all duration-300 group">
                  <t.icon size={24} className="text-teal mb-3 group-hover:scale-110 transition-transform" />
                  <p className="font-medium text-sm text-ink leading-snug">{t.en}</p>
      ...
      <section id="services" className="py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <Reveal className="text-center max-w-2xl mx-auto mb-16">
            <p className="text-teal text-sm font-semibold tracking-widest uppercase mb-3">Our Core Specialities</p>
            <h2 className="font-display font-bold text-4xl sm:text-5xl mb-4">ዋና ዋና አገልግሎቶቻችን</h2>
            <p className="text-dim">Expert, evidence-based rehabilitation plans uniquely built around your recovery goals.</p>
          </Reveal>
          ...
          <Reveal className="mt-20" delay={100}>
            <div className="card p-8 lg:p-12">
              <h2 className="font-display font-bold text-2xl mb-2 text-center">Service Pricing / የክፍያ ዋጋ</h2>
              <p className="text-dim text-sm text-center mb-10">Transparent, fixed pricing per visit type</p>
              <div className="grid sm:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={p.en} className="text-center bg-surface2 rounded-xl p-6 border border-white/5">
                    <p className="font-medium text-ink">{p.en}</p>
                    <p className="amharic text-dim text-xs mb-3">{p.am}</p>
                    <p className="font-display font-bold text-3xl text-teal">{p.price} <span className="text-base text-dim font-normal">ETB</span></p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section id="about" className="py-20 lg:py-28 bg-surface/40">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <Reveal className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="font-display font-bold text-4xl sm:text-5xl mb-4">Why Choose Unique Physiotherapy?</h2>
            <p className="amharic text-teal-light text-lg">ለምን ዩኒክ ፊዚዮቴራፒን ይመርጣሉ?</p>
          </Reveal>
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center mb-20">
            ...
            <Reveal delay={100}>
              <p className="text-dim leading-relaxed mb-6">
                Unique Physiotherapy Speciality Clinic combines expert hands-on clinical knowledge with advanced therapeutic techniques to get you back to complete structural health. We opened our doors in Ayat, Addis Ababa with a simple mission: help every patient move without pain and live without limits.
              </p>
        ...
        <div className="max-w-5xl mx-auto px-5 lg:px-8">
          <Reveal>
            <div className="card p-10 lg:p-16 text-center bg-gradient-to-br from-teal-deep/30 via-surface to-surface relative overflow-hidden">
              <h2 className="font-display font-bold text-3xl sm:text-4xl mb-4">Ready to start your recovery?</h2>
              <p className="amharic text-teal-light mb-2">ህመምዎን ይገላገሉ!</p>
              <p className="text-dim mb-8 max-w-md mx-auto">Book your appointment today and take the first step toward moving freely again.</p>
      ...
      <section id="contact" className="py-20 lg:py-28 bg-surface/40">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <Reveal className="text-center max-w-2xl mx-auto mb-16">
            <p className="text-teal text-sm font-semibold tracking-widest uppercase mb-3">Get In Touch</p>
            <h2 className="font-display font-bold text-4xl sm:text-5xl mb-4">Contact Us</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-10">
            <Reveal className="space-y-5">
              <a href={CLINIC_PHONE_TEL} className="card p-6 flex items-start gap-4 hover:border-teal/40 transition-colors group">
                ...
                <div>
                  <p className="text-xs uppercase tracking-wider text-dim mb-1">Call Us / ለልክ ቀጥር</p>
              ...
              <div className="card p-6 flex items-start gap-4">
                ...
                <div>
                  <p className="text-xs uppercase tracking-wider text-dim mb-1">Location / እድራሻ</p>
                  <p className="font-display font-semibold text-base mb-1">Addis Ababa, Ethiopia</p>
